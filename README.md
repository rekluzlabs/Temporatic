...
Open Temporatic and tap Start.
Switch to the app you want to test.
Tap the floating button whenever you want a screenshot.
The image is saved and queued for sharing.
